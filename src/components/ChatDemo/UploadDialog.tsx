...
//         {/* Hi-Res Ingestion Switch + Tooltip */}
//         <TooltipProvider>
//           <div className="flex items-center space-x-2 mt-4">
//             <Tooltip>
//               <TooltipTrigger asChild>
...
//                 />
//               </TooltipTrigger>
//               <TooltipContent>Ingestion quality: hi-res uses an advanced VLM approach</TooltipContent>
//             </Tooltip>
//             <label className="text-sm">{hiRes? "hi-res" : "fast"}</label>
//           </div>
//         </TooltipProvider>

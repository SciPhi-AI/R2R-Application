...
const RagConfig = () => {
    return (
        <div className="grid gap-4 py-4">
            ...
            <Slider defaultValue={[temperature]} max={2} step={0.01} className="col-span-3 w-full" />
            </div>
            <div className="grid grid-cols-4 items-center gap-4 justify-between">
            <Label htmlFor="top_p" className="text-right">
                top_p
            </Label>
            <Slider defaultValue={[top_p]} max={1} step={0.01} className="col-span-3 w-full" />
            </div>
            <div className="grid grid-cols-4 items-center gap-4 justify-between">
            ...
            <Input id="max_tokens_to_sample" value={max_tokens_to_sample} className="col-span-1 w-24" />
            </div>
        </div>
    )
}
